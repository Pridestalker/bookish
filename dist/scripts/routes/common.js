...
/* harmony import */ var _fortawesome_pro_duotone_svg_icons__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @fortawesome/pro-duotone-svg-icons */ "./node_modules/@fortawesome/pro-duotone-svg-icons/index.es.js");
...
var AddToCart = /*#__PURE__*/function (_Component) {
  ...
  _createClass(AddToCart, [{
    ...
    value: function render() {
      return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(styled_components__WEBPACK_IMPORTED_MODULE_7__.ThemeProvider, {
        theme: theme
        ...
        icon: _fortawesome_pro_duotone_svg_icons__WEBPACK_IMPORTED_MODULE_8__.faShoppingCart,
        className: 'mr-2'
      }), "In winkelmandje")));
    }
  }]);
...
AddToCart.propTypes = {
  id: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().number.isRequired), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string.isRequired)])
};
...
var Bulb = styled_components__WEBPACK_IMPORTED_MODULE_1__.default.span(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\tposition: absolute;\n\tbottom: -.5rem;\n\tleft: -.5rem;\n\tbackground: #6314d2;\n\tcolor: #fff;\n\tborder-radius: 50%;\n\tfont-size: 70%;\n\tpadding: .3rem .5rem;\n\tline-height: 1;\n"])));
...
var ProductContainer = styled_components__WEBPACK_IMPORTED_MODULE_1__.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\nposition: absolute;\n"])));
...
var BarredBottom = styled_components__WEBPACK_IMPORTED_MODULE_4__.default.a(_templateObject || (_templateObject = _taggedTemplateLiteral(["\nposition: relative;\n&::before {\nposition: absolute;\ncontent: ' ';\n}\n"])));
...
Product.propTypes = {
  thumbnail: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_1___default().exact({
  ...
  instock: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOf(['1', '']),
  onsale: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOf(['1', '']),
  ...
  is_new: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOf(['1', '']),
  id: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_1___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string)])
};
...
var Image = styled_components__WEBPACK_IMPORTED_MODULE_2__.default.img(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\t", "\n"])), function (props) {
  return props.outofstock && (0,styled_components__WEBPACK_IMPORTED_MODULE_2__.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n\t\tfilter: grayscale(1);\n\t\tposition: relative;\n\t\tz-index: -1;\n\t"])));
});
